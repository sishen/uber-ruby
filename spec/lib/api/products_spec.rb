  ...
  describe "#products" do
    context "with a valid response" do
      ...
      it "should list all the products" do
        ...
        expect(products[0].product_id).to eql "a1111c8c-c720-46c3-8534-2fcdd730040d" # rubocop:disable Metrics/LineLength
        expect(products[0].image).to eql "http://d1a3f4spazzrp4.cloudfront.net/car.jpg" # rubocop:disable Metrics/LineLength
        ...
        expect(products[1].product_id).to eql "821415d8-3bd5-4e27-9604-194e4359a449" # rubocop:disable Metrics/LineLength
        expect(products[1].image).to eql "http://d1a3f4spazzrp4.cloudfront.net/car.jpg" # rubocop:disable Metrics/LineLength
        ...
        expect(products[2].product_id).to eql "d4abaae7-f4d6-4152-91cc-77523e8165a4" # rubocop:disable Metrics/LineLength
        expect(products[2].image).to eql "http://d1a3f4spazzrp4.cloudfront.net/car.jpg" # rubocop:disable Metrics/LineLength
        ...
        expect(products[3].product_id).to eql "8920cb5e-51a4-4fa4-acdf-dd86c5e18ae0" # rubocop:disable Metrics/LineLength
        expect(products[3].image).to eql "http://d1a3f4spazzrp4.cloudfront.net/car.jpg" # rubocop:disable Metrics/LineLength
        ...
        expect(products[4].product_id).to eql "3ab64887-4842-4c8e-9780-ccecd3a0391d" # rubocop:disable Metrics/LineLength
        expect(products[4].image).to eql "http://d1a3f4spazzrp4.cloudfront.net/car.jpg" # rubocop:disable Metrics/LineLength
      end
    end
  end
