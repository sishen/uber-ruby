...
describe Uber::API::Activities do
  ...
  before do
    stub_uber_request(:get, 'v1.2/history',
# From: https://developer.uber.com/docs/v12-history 
{
  ...
  it "should return the user's activities" do
    ...
    expect(activity.histories[0].request_id).to eql "37d57a99-2647-4114-9dd2-c43bccf4c30b"
    expect(activity.histories[0].uuid).to eql "37d57a99-2647-4114-9dd2-c43bccf4c30b"
